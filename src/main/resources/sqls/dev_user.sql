...
CREATE TABLE `dev_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='开发用户表';
...
INSERT INTO `dev_user` VALUES (1,'test001','测试账户001','123456','',NULL,1,'2019-06-03 15:17:56',NULL,NULL);
...
-- Dump completed on 2019-06-13 20:39:56
